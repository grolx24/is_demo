...
INSTALLED_APPS = [
    ...
    'tg_openai_bot',
    'deal_for_powerbi',
    'autocomplete_crm_tasks.apps.AutocompleteCrmTasksConfig',
    ...
    'duplicate_entity',
    'search_supervisors',
    'start_bp_all_company',
    'download_products',
    'import_crm_googledocs',
    'sort_user_field',
    'tg_bot',
    'calls_to_tgchat',
    'best_managers_call',
...
CALLS_TO_TGCHAT_SYNCH_PERIOD = 2  # период синхронизации в секундах
